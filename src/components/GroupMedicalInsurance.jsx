...
` : ''}
                ...
                <tr>
                    <td class="benefit-name">Average Premium Per Person_${getPremiumLabelA()}</td>
                ...
                <tr>
                    <td class="benefit-name">Average Premium Per Person_${getPremiumLabelB()}</td>
                ...
                <tr>
                    <td class="benefit-name">Total Premium_${getPremiumLabelA()}</td>
